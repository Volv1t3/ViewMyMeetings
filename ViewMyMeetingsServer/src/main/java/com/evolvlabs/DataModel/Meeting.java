...
public class Meeting implements Comparable<Meeting>{
    ...
    public void addInvitee(Employee employee) {
        if (employee != null && this.invitees != null){
            this.invitees.add(employee);
        } else {
            throw new IllegalArgumentException("Error Code 0x001 - [Raised] A Meeting's invitee " +
                                                       "cannot be null during instance creation. " +
                                                       "Similarly, an invitee list cannot be " +
                                                       "null, do not call this method without a " +
                                                       "list created");
        }
    }
